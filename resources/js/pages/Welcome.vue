...
<template>
    <Head title="Welcome" />
    <div
        class="flex min-h-screen flex-col items-center bg-[radial-gradient(circle_at_top,#F23892_0,#0a0a0a_55%,#020617_100%)] p-6 text-white lg:justify-center lg:p-8"
    >
        <header
        ...
        >
            <nav class="flex items-center justify-end gap-4">
                <Link
                    ...
                    :href="dashboard()"
                    class="inline-block rounded-full border border-[#38F298]/70 bg-[#38F298]/10 px-5 py-1.5 text-sm leading-normal text-[#E5FDF4] hover:bg-[#38F298]/20"
                >
                    Dashboard
                </Link>
                <template v-else>
                    <Link
                        :href="login()"
                        class="inline-block rounded-full border border-transparent px-5 py-1.5 text-sm leading-normal text-[#FDFDFE] hover:bg-white/10"
                    >
                        Log in
                    </Link>
                    <Link
                        v-if="canRegister"
                        :href="register()"
                        class="inline-block rounded-full border border-[#BCD1FF]/60 bg-[#BCD1FF]/15 px-5 py-1.5 text-sm leading-normal text-[#E8ECFF] hover:bg-[#BCD1FF]/25"
                    >
                        Register
                    </Link>
                </template>
        ...
        >
            <main
                class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-2xl bg-black/10 backdrop-blur lg:max-w-4xl lg:flex-row"
            >
                <div
                    class="flex-1 rounded-b-2xl bg-slate-950/80 p-6 pb-10 text-[13px] leading-[20px] shadow-[0_0_40px_rgba(0,0,0,0.4)] lg:rounded-l-2xl lg:rounded-br-none lg:p-10"
                >
                    <h1 class="mb-2 text-xl font-semibold text-white">
                        Event Tabulation System
                    </h1>
                    <p class="mb-4 text-sm text-slate-300">
                        Fast, reliable scoring and dramatic live result reveals for
                        pageants, talent shows, and competitions across Luzon.
                    </p>
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        <li
                            class="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-pink-500/40"
                        >
                            <span
                                class="relative bg-transparent py-1"
                            >
                                <span
                                    class="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-pink-400 bg-slate-950"
                                >
                                    <span
                            ...
                            <span>
                                ...
                                <a
                                    href="#"
                                    class="ml-1 inline-flex items-center space-x-1 font-medium text-[#BCD1FF] underline underline-offset-4"
                                >
                                    <span>event categories &amp; criteria</span>
                                    <svg
                                        width="10"
                                        height="11"
                                        viewBox="0 0 10 11"
                        ...
                        <li
                            class="relative flex items-center gap-4 py-2 before:absolute before:top-0 before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-pink-500/40"
                        >
                            <span
                            ...
                            <span>
                                Manage judges, scoring, and live reveal from a
                                <a
                                    href="#"
                                    class="ml-1 inline-flex items-center space-x-1 font-medium text-[#38F298] underline underline-offset-4"
                                >
                                    <span>single tabulation console</span>
                                    <svg
                                        width="10"
                                        height="11"
                                        viewBox="0 0 10 11"
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <Link
                                :href="login()"
                                class="inline-block rounded-full border border-transparent bg-[#F23892] px-6 py-2 text-sm font-medium leading-normal text-white shadow-[0_0_24px_rgba(242,56,146,0.6)] transition hover:bg-[#d0206e]"
                            >
                                Log in to start scoring
                            </Link>
                        </li>
                    </ul>
                </div>
                <div
                    class="relative -mb-px aspect-335/376 w-full shrink-0 overflow-hidden bg-[#F23892] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px]"
                >
                    <svg
